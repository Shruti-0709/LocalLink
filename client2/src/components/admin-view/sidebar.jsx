...
import { LayoutDashboard,ShoppingBasket,SquareMousePointer } from 'lucide-react'
          ...
          <Sheet open={open} onOpenChange={setOpen}>
                <SheetContent side="left" className="w-64 bg-white">
                    ...
                    <SheetHeader className='border-b'>
                        ...
                        <span className='text-2xl font-extrabold text-lime-600'>Admin Panel</span>
                        </SheetTitle>
                    </SheetHeader>
            ...
            <aside className='hidden w-64 flex-col border-r bg-background p-6 lg:flex'>
                ...
                <ChartNoAxesCombined size={30}/>
                    <h1 className='text-2xl font-extrabold text-lime-600'>Admin Panel</h1>
                </div>
                <MenuItems/>
            </aside>
        </Fragment>
